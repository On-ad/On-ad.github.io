...
![](../static/assets/img/post_img/chanuuuuu/ec_structure_LI.jpg)
...
- 자바스크립트에는 `__proto__`를 통한 `prototype Link` 와 `prototype property`가 가리키는 `prototype Object` 가 존재한다. 이 둘을 통칭하여 `prototype`이라고 한다.
    ...
    ![](../static/assets/img/post_img/chanuuuuu/A_object.jpeg)  
...
![](../static/assets/img/post_img/chanuuuuu/observer_relation.png)  
...
- chrome의 console
    ...
    ![](../static/assets/img/post_img/chanuuuuu/browser_this.jpg)  

- nodejs의 console  
      
    ![](../static/assets/img/post_img/chanuuuuu/server_this.jpg)  
